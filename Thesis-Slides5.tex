...
\setbeamercolor{section in head/foot}{bg=bgblue2,fg=black!5}
\setbeamercolor{subsection in head/foot}{bg=bgblue1,fg=black!5}
...
\setbeamertemplate{headline}
{
  \leavevmode%
  \hbox{%
  \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.75ex,dp=1.2ex,right]{section in head/foot}%
    \usebeamerfont{section in head/foot}\insertsectionhead\hspace*{3ex}
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.75ex,dp=1.2ex,left]{subsection in head/foot}%
...
\setbeamerfont{headline}{family=\sffamily\heiti} %series=\bfseries
...
\definecolor{lncolor3}{rgb}{0,0,0}
...
\theorembodyfont{\upshape} %\kaishu\color{black}
\theoremindent0em
...
\newenvironment{example}[1][]{\refstepcounter{example}\par\medskip
   \noindent {\color{structure.fg}{\textbf{例~\thesection.\theexample}}} #1 \rmfamily}{\medskip}
