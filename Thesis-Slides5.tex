...
\setbeamercolor{lower separation line head}{bg=linecolor} %structure.fg!30!bg

%---------- frametitle add a line ----------
\setbeamertemplate{frametitle}{%
  \leavevmode\linespread{1}\centering\insertframetitle\vskip-12pt
  \begin{beamercolorbox}[colsep=0.5pt,wd=11.3cm]{lower separation line head}
  \end{beamercolorbox}
}
...
\newtheorem{corollary}{\sffamily 引理}
