...
{%
  \leavevmode%
  \begin{beamercolorbox}[wd=0.3\paperwidth,ht=2.5ex,dp=1.125ex,center]{author in head/foot}%
    ...
    \hfill
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=0.4\paperwidth,ht=2.5ex,dp=1.125ex,center]{title in head/foot}%
    \usebeamerfont{title in head/foot}\centering \insertshorttitle
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=0.3\paperwidth,ht=2.5ex,dp=1.125ex,right]{date in head/foot}%
