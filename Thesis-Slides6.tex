...
\setbeamertemplate{headline}
{ \leavevmode\begin{beamercolorbox}[wd=\paperwidth,ht=0.5ex,dp=1ex,left]{}
\end{beamercolorbox} }

\setbeamercolor{upper separation line}{bg=linecolor} %structure.fg!30!bg

%---------- frametitle add a line ----------
\setbeamertemplate{frametitle}{%
  \leavevmode\linespread{1}\insertframetitle\vskip-11pt
  \begin{beamercolorbox}[colsep=0.4pt,wd=\linewidth]{upper separation line} %11.3
  \end{beamercolorbox}
}
...
%\sffamily
\begin{center}
\HUGE \textcolor[rgb]{0.8,0,0}{谢\quad 谢! \\[8pt]
Thank you!}
\end{center}
\end{frame}
