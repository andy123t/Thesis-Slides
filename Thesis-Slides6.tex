...
\theoremheaderfont{\bfseries\color{structure.fg}\upshape}
\theorembodyfont{\rmfamily} %\itshape\kaishu\color{black}
\theoremindent0em
...
{\color{structure.fg}{\textbf{例~\thesection.\theexample}}} #1 \rmfamily}{\medskip}

\newenvironment{proof}[1][证明]{{\color{structure.fg}\textbf{#1}:}~}{\hfill\ensuremath{\square}\par}
\newenvironment{solution}{\textbf{解}:~}{\par}
