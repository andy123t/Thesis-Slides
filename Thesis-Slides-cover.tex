...
\begin{center}
\ifx\defheader\undefined{}\else{\color{deepred}\bfseries\large\defheader}\\[2em]\fi%
\begin{beamercolorbox}[wd=\textwidth,sep=8pt,rounded=true,shadow=true,center]{title}
\usebeamerfont{title}\usebeamercolor{title}\inserttitle
\end{beamercolorbox}
\vskip 1.5em
{\renewcommand\arraystretch{1.5}\kaishu%
\begin{tabular}{p{58pt}@{}l}
\makebox[4em][s]{答辩人}\;:&\insertauthor \\
\makebox[4em][s]{专业}\;:&\defmajor \\
\makebox[4em][s]{指导教师}\;:&\defadvisor \\
\makebox[4em][s]{研究方向}\;:&\defstudy \\
\end{tabular}}
\vskip 2em
...
\header{202X\thinspace 届硕士学位论文答辩}
